...
export default function ShallowRoutingExample() {
  ...
  async function ShowDetails(barcodeKala: any) {
    ...
    const response = await fetch(ApiUrl + "Api_SelectKala", { 
        method: "POST",
        headers: {
...
useEffect(() => {
  ...
  async function tempFuncForAsync() {
    ...
    const inputData: InputDataType = {
      IdShobeh: 6,
      // IsJashnvareh: 1,  //zare_nk_050321_commented(ta tedad satrhaye pasokh ziad beshe baraye teste sorat)
      IsJashnvareh: -1,  //zare_nk_050321_added(ta tedad satrhaye pasokh ziad beshe baraye teste sorat)
      NameKala: "",
      IdG1: -1,
      IdG2: -1,
      IdG3: -1,
