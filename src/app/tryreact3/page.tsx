...
//baraye hazfe intervale yad shode az hafezeye computer dar hengame unmount shodane moroorgar,az clearInterval dar entehaye useEffect estefadeh 
// mishe ke baese hazfe interval dar rendere badi nemishe,
...
//varede amal mishe masalan age parametre dovome useEffect([]) ra hazf mikardim va useEffect dar haman mount dobare seda zadeh mishod in 
// dastoore <<return clearInterval(interval1) amal mikard