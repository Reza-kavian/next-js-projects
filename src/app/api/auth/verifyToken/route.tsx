...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // , masalan parsafar dar c# ham vaghti json mikard dadeh ha ra harchi miferestad chon yek akoolad bood fetch va axios dar projeye man anha ra be onvane akoolade avval darnazar migire 
    ...
    // zira tamame khatahaei ke man sakhatm marboot be zamani hast ke barname be khoobi be api miad va dar codehaye api in khatahaye 4XX va 5xx sakhteh mishan,vali khatahaye eshtebah 
    ...
    let errorCode = "";  //zare_nk_041108_added(ijadesh kardam vali estefadehi nakardam azash, mitooneh beonvane code sakhtegiye tekyekalam haye man 
    // baraye tafkike tasmimgiri dar request estefadeh beshe, masalan age token monghazi shod che konim ya age token token namotabar ast che konim)
