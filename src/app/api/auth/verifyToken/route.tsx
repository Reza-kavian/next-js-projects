...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // , masalan parsafar sar c# ham vaghti json mikard dadeh ha ra harch miferestad chon yek akoolad bood fetch va axios dar projeye man anha ra be onvane akoolade avval darnazar migire 
    ...
    // nemisheh va error mideh ke behtare try catch besazim ke barname dar mavarede ghtiye shabakeh va net be catch bereh va oonja error ro alert mikonim baraye karbar  
