...
export const metadata = { //zare_nk_041013_nokteh(be khatere in dastkari majboor shodim metadata ra az layout import konim vagarnah barnameh automat
//  in const ba lafze metadata(faghat metadata) ra dar tage html title gharar midad)
    title: `${layoutMetadata.title} - About04`, 
};
...
export default function Page() { 
  ...
  return (
    <>
      {/* <title>{metadata.title}</title> */}  {/*zare_nk_040507_nokteh(neveshtane metadata dakhle tage title osooli nist va pishnahad nemishe,
      barnameh ham automat metadata ro beonvane mohtavaye tage title safhe dar nazar migire)*/} 
